    ...
    $(function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (results) {
                    $("#detailImg").append("<a href='" + results.site_detail_url + "' target='_blank'><img src='" + results.image.screen_url + "' /></a>");
                    ...
                    $("#titleCont").append("<h4><a href='" + results.site_detail_url + "' target='_blank'>" + results.name + "</a></h4>");
                    if (results.deck) {
                        $("#descCont").append("<p><a href='" + results.site_detail_url + "' target='_blank'>" + results.deck + "</a></p>");
                    }
                    else {
                        $("#descCont").append("<p><a href='" + results.site_detail_url + "' target='_blank'>" + results.description + "</a></p>");
                    }
                }
            }
